...
To run in chrome , go to TestNG.xml and update parameter value ="chrome" for edge value="edge" .

Chrome might not run if the driver and chrome version does not match.Current driver is for chrome version : 75
Edge might not run if edgeDriver and windows version does not match.Current driver is for Windows OS build : 17134
